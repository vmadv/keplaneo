...
export default async function CategoriaMesPage({
  ...
  params: Promise<{ comunidad: string; municipio: string; categoriaOMes: string; mes: string }>;
}) {
  const { comunidad: comunidadSlug, municipio: municipioSlug, categoriaOMes, mes } = await params;
